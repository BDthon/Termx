...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    text = f"هاي جلستك ورده {ty} 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐷𝑇𝐻𝑂𝑁** \n\n`{string_session}` \n\n**ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :** @zzsszzz \n🍒 **ɴᴏᴛᴇ :** حافظ عليها ممكن حد يخترقكك بيها\n اشترك بالحب @BDthon 🥺"
    try:
        if not is_bot:
